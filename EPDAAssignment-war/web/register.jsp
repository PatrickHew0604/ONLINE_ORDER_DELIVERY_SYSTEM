...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function validateForm() {
                return validatePasswords() && validateNRIC() && validatePhoneNumber();
            }
    ...
    <body><div class="container">
            ...
            <form action="Register" method="POST" onsubmit="return validateForm();">
                ...
                <input type="text" name="identityCardNumber" id="identityCardNumber" required pattern="\d{6}-\d{2}-\d{4}" placeholder="e.g., 900101-14-1234">
                <br><br>
