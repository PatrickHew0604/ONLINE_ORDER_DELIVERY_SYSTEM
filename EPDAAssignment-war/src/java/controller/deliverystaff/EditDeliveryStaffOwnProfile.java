 ...
 * @author wengk
 */
public class EditDeliveryStaffOwnProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (username != null) {
            ...
            MyUser newUser = new MyUser(username, password, Role.DELIVERYSTAFF, name, email, gender, phoneNumber, identityCardNumber, address,true);
        ...
        request.setAttribute("action", "EditDeliveryStaffOwnProfile");
        request.setAttribute("href", "deliveryStaffMainPage.jsp");
