<%-- 
    ...
    Created on : 11/10/2024, 5:30:25 PM
    Author     : wengk
--%>
...
<html>
    <head>
        ...
        <title>Update Customer Input</title>
    </head>
    <body>
        <div class="container">
            <a href="UpdateCustomer" class="back-btn">&lt; Back</a>
            <h2>Manage Customer Form</h2>
            <form action="UpdateCustomerInputForm" method="POST" onsubmit="return validateForm();">
