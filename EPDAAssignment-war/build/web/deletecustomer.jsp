...
<html>
    ...
    <body>
        <div class="container">
            <a href="managecustomer.jsp" class="back-btn">&lt; Back</a>
                ...
                <tbody>
                    <c:forEach var="user" items="${users}">
                        <tr>
                            ...
                            <td>${user.address}</td>
                            <td>
                                <form action="DeleteCustomer" method="post" onclick="return confirm('Are you sure you want to delete this Customer?');">
                                    <input type="hidden" name="deletedUsername" value="${user.username}">
