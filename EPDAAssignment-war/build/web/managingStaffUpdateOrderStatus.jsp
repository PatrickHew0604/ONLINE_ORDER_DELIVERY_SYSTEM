                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="UpdateOrderStatus" method="POST">
                                        ...
                                        <c:choose>
                                            <c:when test="${order.orderStatus == 'READYFORDELIVERY'}">
                                                <button class="order-details-btn" type="submit" name="action" value="assignDeliveryStaff">Assign to Delivery Staff</button>
                                                <button class="revert-btn" type="submit" name="action" value="revertStatus">Revert Status</button>
                                            </c:when>
                                            <c:when test="${order.orderStatus == 'ORDERRECEIVED'}">
                                                <button class="order-details-btn" type="submit" name="action" value="updateStatus">Update Status</button>
                                                <button class="revert-btn" type="submit" name="action" value="revertStatus">Revert Status</button>
                                            </c:when>
