...
<html>
    ...
    <body>
        ...
        <div class="container">
                    ...
                    <tbody>
                        <c:forEach var="order" items="${orders}">
                            <tr>
                                ...
                                <td>
                                    <form action="DeliveryStaffViewAssignedOrderPage" method="POST">
                                        <input type="hidden" name="orderID" value="${order.orderID}">
                                        <c:choose>
                                            <c:when test="${order.orderStatus == 'DELIVERING'}">
                                                <button class="order-details-btn" type="submit" name="action" value="updateDeliveryStatus">Update Status</button>
                                            </c:when>
                                            <c:when test="${order.orderStatus == 'DELIVERED'}">
                                                <button class="order-details-btn" type="submit" name="action" value="generateReceipt">Generate Receipt</button>
                                            </c:when>
            ...
            <a href="deliveryStaffMainPage.jsp" class="back-btn">Back to Main Page</a>
        </div>
